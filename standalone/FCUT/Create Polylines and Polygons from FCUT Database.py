...
lineworkFile = outputFolder + "\\linework_"+ datetime.datetime.now().strftime("%m%d%Y") +".shp"		# Name of LINEWORK output file
polygonFile = outputFolder + "\\polygons_"+ datetime.datetime.now().strftime("%m%d%Y")+".shp"		# Name of POLYGON output file
